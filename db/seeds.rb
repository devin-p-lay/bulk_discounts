...
customer = Customer.create(first_name: "Joe", last_name: "Schmoe")
invoice = customer.invoices.create(status: 1)

merchant_a = Merchant.create(name: "Devin's")
item_a1 = Item.create(name: "my item 1", description: 'description', unit_price: 10, merchant_id: merchant_a.id)
item_a2 = Item.create(name: "my item 2", description: 'description', unit_price: 10, merchant_id: merchant_a.id)
