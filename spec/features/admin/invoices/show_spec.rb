...
describe 'Admin Invoices Index Page' do
  ...
  it 'should display the total revenue the invoice will generate without discounts applied' do
  ...
  it 'show total revenue from this invoice including discounts' do
    expect(page).to have_content(@i1.invoice_items.discount_revenue)
  end
end
